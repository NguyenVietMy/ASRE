          ...
          <div className="h-full flex flex-col">
            ...
            <div className="p-4 border-t border-border">
              ...
              <div className="mt-2 space-y-1">
                ...
                <button className="w-full flex items-center gap-3 px-4 py-2 rounded-lg text-sm text-muted-foreground hover:bg-secondary hover:text-foreground transition-colors">
          ...
          <div className="p-6">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                {[
                  { title: 'Active Incidents', value: '0', change: '+0%' },
                  { title: 'System Health', value: '100%', change: 'Stable' },
                  { title: 'Total Metrics', value: '0', change: '+0' },
                  { title: 'Logs Processed', value: '0', change: 'Today' },
                ].map((stat, index) => (
                  <div
                    key={index}
              ...
              <div className="bg-card border border-border rounded-xl p-8">
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold mb-2">Dashboard Content</h3>
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Your dashboard content will appear here. Add metrics, charts, and other widgets as needed.
                  </p>
                </div>
              </div>
            </div>
